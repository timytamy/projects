...
public class HotGoal {
    ...
    public void SetEaRgbValues(byte[] eaRgb) {
        ...
        TimePrint("Setting individual RGB values");
    ...
    public void MakeTcpConnection (string tcpAddr, int tcpPort) {
        ...
        if (attempts >= 3) {
            TimePrint("Attempted and Failed 3 times");
        }
    }
...
public class TestProgram {
    ...
    public static void Main () {
        byte[] temp = new byte[12] {0, 0, 0, 111, 111, 111, 222, 222, 222, 33, 33, 33};  
