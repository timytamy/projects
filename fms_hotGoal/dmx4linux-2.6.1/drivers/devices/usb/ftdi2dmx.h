 ...
 * and
 *	http://www.circellar.com, issue 170 (september 2004)
 *
...
#define FTDI_DMX512_PID 0xEC70  /* FT232BM as usb-dmx-512 project */
/* according to the article in Circuit Cellar Ink (issue 170, page 72),
 * FTDI has reserved this PID for the dmx-512 project.  Program the eeprom
 * attached to the FT232BM with this ID to use this driver. */

#define ENTTEC_OPENDMXUSB_PID (0x6001)
